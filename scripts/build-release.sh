...
(cd apps/api && go vet ./... && go test ./... && CGO_ENABLED=0 go build -trimpath -o ../../.local/release/tutor-api ./cmd/api && CGO_ENABLED=0 go build -trimpath -o ../../.local/release/tutor-migrate ./cmd/migrate)
